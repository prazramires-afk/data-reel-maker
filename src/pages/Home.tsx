    ...
    <div className="min-h-screen flex flex-col relative overflow-x-hidden">
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 w-full">
        ...
        <div className="mt-10 grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            { icon: BarChart3, title: "Animated Bar Chart Race", body: "Smooth reordering bars across years or rounds — the most viral data format on short-form video." },
            ...
            { icon: TrendingUp, title: "Data Storytelling", body: "Built-in titles, viral hooks and reveal animations turn raw numbers into a narrative viewers finish." },
            { icon: Trophy, title: "Sports Statistics Videos", body: "Goal scorers, championship races, head-to-head player comparisons — perfect for football and esports pages." },
            ...
            { icon: GraduationCap, title: "Educational Timelines", body: "Animate population growth, historical events and demographic data for educational TikTok and YouTube." },
          ].map((f) => (
